<template>
  <div class="bootpage" id="bootpage">
    <div class="bootpage-logo">
      ...
      <a href="http://bbs.working.vip">雁行官网</a>
    </div>
    <div class="bootpage-content">
      ...
      <div class="bootpage-button" @click="toLogin">开始工作</div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      bootvideo: require("@/assets/earth-video.mp4"),
      videoState: true,
      videoWidth: "50%",
      videoHiehgt: 0
    };
  ...
  beforeMount() {
    ...
    window.onresize = function() {
      ...
      if (document.documentElement.clientWidth < 900) {
       ...
       document.querySelector("#myVideo video").style.height =  document.querySelector("#bootpage").offsetHeight + "px";
    };
  },
  mounted() {
    this.initVideo();
