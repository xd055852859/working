  ...
  >
    ...
    <div class="taskItem-container">
      ...
      <div class="taskItem-footer" v-if="!bottomtype">
        ...
        <div :style="{maxWidth:'64px',display:'flex'}">
          ...
          <div class="taskItem-check-icon">
            <img
              v-if="cardKey==cardItem._key&&!cardItem.importantStatus"
              :src="unimportant"
          ...
          <div
            class="taskItem-check-icon"
            v-if="cardKey==cardItem._key||cardItem.content"
            :style="{color:'#333'}"
          >
      ...
      <div
        ...
        :style="cardKey==cardItem._key?{borderTop:'10px solid '+color[cardItem.taskType==10?5:cardItem.taskType-1],borderRight:'10px solid '+color[cardItem.taskType==10?5:cardItem.taskType-1],  borderLeft: '10px solid transparent',
...
export default {
  name: "TaskItem",
  props: ["cardItem", "executorKey", "dateType", "viewState", "bottomtype"],
  ...
  methods: {
    ...
    chooseTodayTask(type) {
      // this.setCardKey(this.cardItem._key);
      let obj = {
    ...
    checkCard(key, groupKey) {
      ...
      this.setCardDetail(this._.cloneDeep(this.cardItem));
      this.getCardMember({
        groupId: groupKey,
      });
      this.cardRole = !(
      ...
      this.setCardExecutorKey(this.cardItem.executorKey);
      if (!this.cardRole) {
        this.changeCardDetailType(2);
