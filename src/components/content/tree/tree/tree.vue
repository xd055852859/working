  ...
  <Drag>
    ...
    >
      ...
      >
        ...
        <g v-for="(node, index) in c_nodes" :key="index" :class="`node-group-${index}`">
          <Node
            :node="node"
          ...
          <Dot :node="node" :BLOCK_HEIGHT="BLOCK_HEIGHT" :handleClickExpand="handleExpand" />
          <Expand
            :node="node"
            :BLOCK_HEIGHT="BLOCK_HEIGHT"
